...
!  Purpose: Evaluate TSSPR detection limits and run-length performance.
!==============================================================
module performance_evaluation
...
!  Purpose: Initialize TSSPR and SampleGen static data.
!==============================================================
subroutine Init_Performance_Evaluation( Nodesset, B0_all, B1_all, CovMat)
    ...
    ! 2. Initialize TSSPR Data
    ! TSSPR maintains internal Likelihood and R statistics
    call Init_TSSPR_Data()
...
subroutine TSSPR_EstimateLimitRange(noise_type, back_index, &
    ...
    if (is_master) then
        ...
        print *, "==== Auto-Estimating Limit Range (TSSPR) ===="
    end if
    ...
    if (is_master) then
        ...
        do
            ...
            do j = 1, Time_window
                ...
                call TSSPR(OnlineSample, sampling_index, charting_statistic)
            end do                
    ...
    if (is_master) then
        ...
        target_idx_L = int(dble(IC_TestRuns) * (1.0d0*Time_window/(IcArl-20.0d0)))
        target_idx_L = max(1, min(IC_TestRuns, target_idx_L))
        
        target_idx_U = int(dble(IC_TestRuns) * (1.0d0*Time_window/(IcArl+200.0d0)))
...
end subroutine TSSPR_EstimateLimitRange

!==============================================================
!  Subroutine: TSSPR_limitSearch
!  Cumulative simulation CPU time is recorded.
!==============================================================
subroutine TSSPR_limitSearch(noise_type, back_index, &
    ...
    if (is_master) then
        ...
        print *, "==== Begin TSSPR_limitSearch (Cumulative Timing) ===="
      ...
      if (is_master) then        
            if (abs(global_arl - IcArl) < Icstd) then
                ...
                if (.not. present(fid)) then
                    print '(A,F12.6,A,F12.6,A,F12.6)', " TSSPR Search: [", LimitL, ",", LimitR, "] Try:", Limit
                end if
            end if
        end if
...
end subroutine TSSPR_limitSearch

!==============================================================
!  Subroutine: TSSPR_OCARL
!==============================================================
!==============================================================
!  Subroutine: TSSPR_OCARL
!  Returns out-of-control, exploration, and exploitation statistics.
!==============================================================
subroutine TSSPR_OCARL(noise_type, back_index, anomaly_type, &
    ...
    if (is_master) then
        ...
        print *, "==== Begin TSSPR_OCARL_Extended ===="
    end if
    ...
    if (is_master) then
        ...
        do while (active_workers > 0)
            ...
            if (mod(recv_count, print_step) == 0) then
                print '(A,I0,A,I0,A,F10.4)', " TSSPR OCARL Progress: ", recv_count, "/", simu, &
...
!==============================================================
!  Subroutine: TSSPR_ICPerformance
!==============================================================
subroutine TSSPR_ICPerformance(noise_type, back_index, Limit, falserate)
    implicit none
    ...
    if (is_master) then
        print *, "==== Begin TSSPR_ICPerformance_dynamic ===="
        global_falsecount = 0
    end if
...
end subroutine TSSPR_ICPerformance
